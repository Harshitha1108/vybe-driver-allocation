...
let DriversController = class DriversController {
    ...
    findNearbyDrivers(latitude, longitude) {
        return this.driversService.findNearbyDrivers(Number(latitude), Number(longitude));
    }
};
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], DriversController.prototype, "findNearbyDrivers", null);
